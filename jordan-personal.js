...
module.exports = function(app) {
  ...
  app.post('/whatsapp', async function(req, res) {
    ...
    if (!STU_NUMBER || !From.includes(STU_NUMBER.replace('+', ''))) {
